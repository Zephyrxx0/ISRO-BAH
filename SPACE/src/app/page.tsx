...
export default function Home() {
  ...
  return (
    <div className="flex-1 w-full max-w-[1600px] mx-auto p-4 md:p-6 space-y-6 select-none font-mono">
      ...
      <header className="border border-border-brutal bg-background p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
      ...
      <footer className="border border-border-brutal bg-background p-4 flex flex-col md:flex-row justify-between items-center text-[9px] text-raw-zinc">
